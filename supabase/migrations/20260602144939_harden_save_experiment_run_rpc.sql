...
set search_path = ''
as $$
  select private.save_experiment_run_internal(
    p_lab_id, p_title, p_variables, p_live_values, p_graph_points, p_table_rows,
    p_prediction, p_reflection, p_summary, p_score, p_duration_seconds
  );
$$;
