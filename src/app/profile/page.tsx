          ...
          <aside className="hidden lg:flex lg:col-span-3 flex-col bg-white/90 backdrop-blur-md border border-slate-200/50 rounded-[32px] p-6 shadow-sm min-h-[580px] justify-between">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-slate-100 select-none">
                <div className="w-9 h-9 rounded-xl bg-blue-100 flex items-center justify-center overflow-hidden">
                  <img src="/student_avatar_3d.png" alt="SciSiam Logo" className="w-full h-full object-cover" />
                </div>
            ...
            <div className="mt-8 border-t border-slate-50 pt-5 flex flex-col items-center">
              ...
              <div className="w-28 h-28 select-none pointer-events-none mt-2">
                <img src="/student_avatar_3d.png" alt="Mascot Penguin" className="w-full h-full object-contain" />
              </div>
            </div>
          </aside>
              ...
              <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-r from-blue-400 via-indigo-400 to-blue-500 p-[1.2px] shadow-lg shadow-indigo-500/10 group hover:shadow-xl hover:shadow-indigo-500/15 transition-all duration-300">
                ...
                <div className="bg-white/95 rounded-[23px] px-6 py-4.5 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left relative overflow-hidden min-h-[96px]">
                  ...
                  <div className="absolute -left-2 -bottom-5 w-24 h-24 select-none pointer-events-none z-10">
                    <img src="/student_avatar_3d.png" alt="Penguin mascot" className="w-full h-full object-contain" />
                  </div>
