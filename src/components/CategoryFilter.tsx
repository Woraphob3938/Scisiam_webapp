        ...
        {categoriesList.map((category) => {
          ...
          return (
            <button
              ...
              className={`
                flex min-h-11 min-w-0 cursor-pointer select-none items-center justify-center gap-1.5 rounded-full border px-1.5 py-2 text-xs font-bold leading-[1.45] tracking-normal sm:gap-2 sm:px-3 sm:text-sm
