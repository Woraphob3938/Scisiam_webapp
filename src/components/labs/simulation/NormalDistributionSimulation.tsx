            ...
            <section className="flex flex-col gap-4 rounded-2xl border border-slate-200/70 bg-white p-5 shadow-sm">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-black text-white shadow-md transition-all hover:bg-indigo-700 active:scale-98 disabled:opacity-50 disabled:pointer-events-none"
                >
