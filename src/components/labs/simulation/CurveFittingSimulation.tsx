...
export default function CurveFittingSimulation() {
  ...
  const controls = (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button type="button" onClick={() => setMode("linear")} className={`rounded-xl border px-3 py-2 text-xs font-black ${mode === "linear" ? "border-violet-200 bg-violet-600 text-white" : "border-violet-100 bg-violet-50 text-violet-700"}`}>
          linear trend line
        </button>
  ...
  const compactControls = (
    <div className="grid gap-3 sm:grid-cols-[1fr_1fr_170px]">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button type="button" onClick={() => setMode("linear")} className={`rounded-xl px-3 py-2 text-xs font-black ${mode === "linear" ? "bg-violet-600 text-white" : "bg-violet-50 text-violet-700"}`}>
          linear
        </button>
