...
import { Sliders, RotateCcw, ClipboardList, Activity, Play, Pause, Layers, Thermometer, Zap, Eye, Sparkles, Clipboard, Download, Trash, CheckCircle2, Target } from "lucide-react";
