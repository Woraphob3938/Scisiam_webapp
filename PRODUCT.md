...
It should also avoid misleading readiness: unsupported labs must not route to the wrong simulation, mock profile data must not pretend to be production truth, and AI features must not imply perfect correctness.
